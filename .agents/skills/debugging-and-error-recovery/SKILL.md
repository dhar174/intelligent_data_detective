...
# Run a specific failing test by name substring
pytest -k "test_name" -v

# Run an exact test file with verbose tracebacks
pytest test_intelligent_data_detective.py -v --tb=short

# Run in isolation and stop at first failure with debugger
